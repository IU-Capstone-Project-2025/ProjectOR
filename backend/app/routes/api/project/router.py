...
async def get_project_by_id(project_id: int, service: ProjectServiceDep) -> ProjectSchema:
    return await service.get_project_by_id(project_id)

@router.post("/")
async def create_project(project_data: ProjectSchema, service: ProjectServiceDep) -> ProjectSchema:
